...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  document.getElementById('arreyVuoto').innerHTML += '"' + starWarsCharacters[i].name + '", ';
}
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  if (starWarsCharacters[i].gender === 'female') {
    ...
    document.getElementById('oggettoFemale').innerHTML += '"' + starWarsCharacters[i].name + '", ';
  } else;
}
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  somma += starWarsCharacters[i].mass;
}
crewMass.push(somma);
